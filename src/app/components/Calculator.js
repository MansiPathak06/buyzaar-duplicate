...
// //     const franchiseFee = martDetails.franchiseFee;

// //     // Calculate subtotal (before security)
// //     const subtotal = stock + interior + softwareFee + franchiseFee;

// //     // Calculate security as 6.6% of subtotal
// //     const security = Math.round(subtotal * 0.066);

// //     return { stock, interior, softwareFee, franchiseFee, security };
// //   };
...
// //             Hyper Mart franchise including stock, interior, software fee,
...
// //                     Select Area:{" "}
// //                     <span className="text-[#b00000]">600 - 8000</span> sqft
// //                   </label>
// //                   {/* Area Input */}
...
// //             {/* Cost Breakdown Card */}
// //             <div className="bg-white rounded-xl sm:rounded-2xl shadow-lg p-6 lg:p-8">
...
// //                   </span>
// //                   <span className="text-sm sm:text-base font-semibold text-gray-800">
// //                     ₹ {formatCurrency(costs.franchiseFee)}
// //                   </span>
// //                 </div>
...
// //               {/* Buttons Container */}
// //               <div className="flex flex-col gap-3 sm:flex-row sm:gap-4 items-center justify-center mt-6">
// //                 {/* Download Button */}
// //                 <button
...
//     // Add 18% GST to franchise fee
//     const franchiseFeeWithGST = Math.round(franchiseFee * 1.18);
...
//     let security;
//     if (area === 600) {
//       // For 600 sqft, security is constant at 1,00,000
//       security = 100000;
//     } else {
//       // For area > 600, security is 6.66% of subtotal
//       security = Math.round(subtotal * 0.0666);
//     }

//     return { stock, interior, softwareFee, franchiseFee, franchiseFeeWithGST, security };
//   };
...
//   // Total cost is sum of all cost components (using franchise fee with GST)
...
//                   </span>
//                   <span className="text-sm sm:text-base font-semibold text-gray-800">
//                     ₹ {formatCurrency(costs.franchiseFeeWithGST)}
//                   </span>
//                 </div>
...
//                 <div className="flex justify-between items-center pb-2 border-b border-gray-200">
//                   <span className="text-sm sm:text-base text-gray-600">
//                     Security Deposit {area === 600 ? "(Fixed)" : "(6.66%)"}
//                   </span>
//                   <span className="text-sm sm:text-base font-semibold text-gray-800">
//                     ₹ {formatCurrency(costs.security)}
//                   </span>
...
const Calculator = ({ openModal }) => {
  ...
  const calculateCosts = () => {
    ...
    if (area === 600) {
      ...
      // For area > 600, security is 6.66% of subtotal, but minimum 1,00,000
      const calculatedSecurity = Math.round(subtotal * 0.0666);
      security = Math.max(calculatedSecurity, 100000);
    }
